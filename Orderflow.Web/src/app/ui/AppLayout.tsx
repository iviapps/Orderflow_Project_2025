            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              {isAuthenticated ? (
                ...
                <>
                  ...
                  <Link to="/login" className="btn-primary btn-md shadow-md hover:shadow-lg">
                    Iniciar Sesion
                  </Link>
                </>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Sistema de gestion de pedidos e-commerce moderno y eficiente.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-3">Enlaces Rapidos</h3>
              <ul className="space-y-2 text-sm">
                <li><Link to="/" className="text-gray-600 hover:text-primary-600 transition">Productos</Link></li>
                <li><Link to="/orders" className="text-gray-600 hover:text-primary-600 transition">Pedidos</Link></li>
                <li><Link to="/profile" className="text-gray-600 hover:text-primary-600 transition">Perfil</Link></li>
              </ul>
            </div>
            <div>
